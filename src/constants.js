export const INITIAL_CODE_LIST = ['US', 'ES', 'GB', 'UA'];

export let STORAGE_CODE_LIST =
    localStorage.getItem('storageCodeList') ?
    localStorage.getItem('storageCodeList').split(',') : [];

    console.log(STORAGE_CODE_LIST);

export const filterStorage = (code) => {
  STORAGE_CODE_LIST = STORAGE_CODE_LIST.filter(e => e !== code);
  localStorage.setItem('storageCodeList', STORAGE_CODE_LIST);
};
